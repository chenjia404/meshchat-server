...
type GroupMessage struct {
	...
	MessageID            string         `gorm:"type:uuid;not null;uniqueIndex:idx_group_message_message_id,priority:2" json:"message_id"`
	...
	ReplyToMessageID     *string        `gorm:"type:uuid;index:idx_group_reply,priority:2" json:"reply_to_message_id"`
	ForwardFromMessageID *string        `gorm:"type:uuid;index" json:"forward_from_message_id"`
